...
export class JackParser extends antlr.Parser {
  ...
  public subroutineDeclaration(): SubroutineDeclarationContext {
    let localContext = new SubroutineDeclarationContext(
      this.context,
      this.state,
    );
  ...
  public subroutineDecWithoutType(): SubroutineDecWithoutTypeContext {
    let localContext = new SubroutineDecWithoutTypeContext(
      this.context,
      this.state,
    );
  ...
  public subroutineReturnType(): SubroutineReturnTypeContext {
    let localContext = new SubroutineReturnTypeContext(
      this.context,
      this.state,
    );
  ...
  public varNameInDeclaration(): VarNameInDeclarationContext {
    let localContext = new VarNameInDeclarationContext(
      this.context,
      this.state,
    );

...
const FIG7_3A_PARSED = {
  instructions: [
    { op: "push", segment: "constant", offset: 2 },
    { op: "push", segment: "local", offset: 0 },
    { op: "sub" },
    { op: "push", segment: "local", offset: 1 },
    { op: "push", segment: "constant", offset: 9 },
    { op: "add" },
    { op: "add" },
    { op: "pop", segment: "local", offset: 2 },
  ],
} satisfies Vm;
...
const FIG8_1_PARSED = {
  instructions: [
    ...
    { op: "push", segment: "local", offset: 1 },
    { op: "push", segment: "argument", offset: 1 },
    { op: "lt" },
    { op: "neg" },
...
const FIG8_2_PARSED = {
  instructions: [
    { op: "function", name: "main", nVars: 0 },
    { op: "push", segment: "constant", offset: 3 },
    { op: "push", segment: "constant", offset: 4 },
    { op: "call", name: "hypot", nArgs: 2 },
    { op: "return" },
    { op: "function", name: "hypot", nVars: 2 },
    { op: "push", segment: "argument", offset: 0 },
    { op: "push", segment: "argument", offset: 0 },
...
const FIG8_4_PARSED = {
  instructions: [
    ...
    { op: "return" },
    { op: "function", name: "factorial", nVars: 1 },
    { op: "push", segment: "argument", offset: 0 },
    { op: "push", segment: "constant", offset: 1 },
    { op: "eq" },
